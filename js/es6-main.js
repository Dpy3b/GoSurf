...
animateClass: 'animated', // default offset:       200,          // not default
mobile:       true,       // default
live:         true        // default
});
...
$(function(){
    ...
    $('.header__slider').slick({
        ...
        infinite: true,
        fade: true, 
        prevArrow: '<img class="slider-arrow slider-arrow-left" src="./images/svg/arrow-left.svg" alt=""></img>',
        nextArrow: '<img class="slider-arrow slider-arrow-right" src="./images/svg/arrow-right.svg" alt=""></img>', 
    });
...
let mapSvg = document.querySelector('.header__map-svg');
...
$('.surf-list').slick({
    ...
    slidesToShow: 5,
    slidesToScroll: 3,
    prevArrow: '<img class="slider-arrow slider-arrow-left surf-arrow" src="images/svg/arrow-left.svg" alt=""></img>',
    nextArrow: '<img class="slider-arrow slider-arrow-right surf-arrow" src="images/svg/arrow-right.svg" alt=""></img>',
      responsive: [
    {
      breakpoint: 1760,
      settings: {
